...
var colorfulTabsOptions1 = {
	...
	changeUI:function(el,prompt)
		...
		if(!el.checked || (clrScheme != 2) || (clrScheme != 3))
			{
			if(prompt && clrScheme != 2 && clrScheme != 3)
				{
				alert("Please be aware that this feature only works with \"Generate Colors By Domain Hostname\" and \"Color only the tabs you want\" under \"General\".")
